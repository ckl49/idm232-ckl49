...
<!-- nav for normal desktop -->
    ...
    <main>
                            ...
                            <a href="recipe.php?name=' . urlencode($row["name"]) . '" class="recipe-card-link" >
                                <div class="recipe-card">
                                    <div class="image-and-recipe-title">
                                        <picture>
                                            <source srcset="' . $small_first_image . '" media="(max-width: 732px)">
                                            <img src=" '. ($first_image) .'" alt=" '. ($row["name"]) . ' ">
                                        </picture>                                        <div class="recipe-card-title">
        ...
        <section class="second-hero-section fade-up">
            ...
            <div class="second-hero-section-div">
                <div>
                    <h2 class="display-h2">Cooking has never been easier!</h2>
                    <p class="subheading">Use our recipes to start plating today!</p>
                </div>
                <a href="recipes.php" class="anchor-button">Search for a recipe</a>
