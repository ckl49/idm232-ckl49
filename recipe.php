<?php
    ...
    if (isset($_GET["name"])) {
        ...
        if ($result->num_rows > 0) {
            ...
            $kitchenTool= $row["kitchen_tool"] ?? '';
            $steps      = $row["steps"] ?? '';
            $tip        = $row["tip"] ?? '';
            $images     = $row["images"] ?? '';
            $smallImages= $row["mobile_images"] ?? '';
        } else {
            echo "Recipe not found, '$name' doesn't exist";
        }    
    }
        ...
        <section class="xl-gap">
            <section class="recipe-page-hero fade-up">
                <div class="recipe-page-hero-div">
                    ...
                    <a class="anchor-button" href="#step-section"> Jump to steps</a>
                </div>
                <div class="hero-img">
                    <?php 
            ...
            <section class="recipe-page-ingredients-section fade-up">
                <div class="ingredients-div">
                    ...
                    <?php
                        ...
                        echo '
                            <picture>
                                <source srcset="' . $small_ingredient_img . '" media="(max-width: 600px)">
                                <img src="' . $ingredient_img . '" alt=ingredients"' . '">
                            </picture>
                            '
                        ;
                    ?>
            ...
            <section class="step-section" id="step-section">
                <div>
                    <h2>Steps</h2>
                    <p>It's time to cook! Follow these steps to get plating.</p>
                </div>            
                <?php 
                    $steps_array = explode("*", $steps);

                    if (!empty($steps_array) && !empty($image_array)) {
                        ...
                        for ($i = 3; $i < count($image_array); $i++) {    
                            ...
                            echo '
                                <div class="step-details fade-up">
                                    ...
                                    <p class="step-title">Step ' . ($step_index + 1) . '</p>
                                    <p>' . htmlspecialchars(string: $step_text) . '</p>
                                </div>
                            ';
                        }
                    }
        ...
        <section class="section-carousel fade-up">
            <div class="section-header">
                <div>
                    ...
                    <p class="subheading">See what other's have been making...</p>
                </div>
            ...
            <!-- build carousel -->
                ...
                <?php
                    ...
                    while ($row = $carousel_result->fetch_assoc()) {
                        ...
                        if ($count <= 7) {
                            echo '
                            <a href="recipe.php?name=' . ($row["name"]) . '" class="recipe-card-link" >
                                <div class="recipe-card">
                                    <div class="image-and-recipe-title">
                                        <picture>
                                            <source srcset="' . $small_first_image . '" media="(max-width: 600px)">
                                            <img src=" '. ($first_image) .'" alt=" '. ($row["name"]) . ' ">
                                        </picture>
