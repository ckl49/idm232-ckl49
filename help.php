...
<nav class="horizontal-nav-menu">
    ...
    <main class="center-content">
        <section class="fill">
            <div class="header">
                <h1>Help</h1>
                <p>Don't know what to do? We got you!</p>
            </div>
            <div>
                <p>this is plated! i made this for my IDM 232 class focused on learning php and mysql. to explore the page, use the top navigation bar to look through all the recipes!</p>
            </div>
        </section>
    </main>
    <footer>
