    ...
    <nav class="mobile-menu">
        ...
        <div class="overlay-nav-menu">
            <ul class="overlay-nav-ul">
                ...
                <li><a href="recipes.html">Search</a></li>
    ...
    <main class="center-content"> 
        <div class="all-recipes-wrapper">
            <section class="header">
                <h1>All Recipes</h1>
                <p>Browse all of our available recipes.</p>
                ...
                <div class="filters-active-search">
                    <div class="div-row">
                    <form action="no-results.html" class="search-bar">
                        <input type="search" id="search" placeholder="Search..." />
                        <button class="icon-btn"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="none" stroke="#111820" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M5 12h14m-7-7l7 7l-7 7"/></svg></button>
                    </form>
                ...
                <div class="filters-modal">
                    ...
                    <ul class="list-of-filters">
                        <li>
                            <label class="filter-choice">
                                <input type="checkbox" id="filter-meat" name="filter" value="meat">
                                Meat
                              </label>
                        </li>
                        <li>
                            <label class="filter-choice">
                                <input type="checkbox" id="filter-vegetables" name="filter" value="vegetables">
                                Vegetables
                              </label>
                        </li>
                        <li>
                            <label class="filter-choice">
                                <input type="checkbox" id="filter-asian" name="filter" value="asian">
                                Asian
                              </label>
                        </li>
                        <li>
                    ...
                    <button id="search-filters-btn">Search filters</button>
                </div>
                    <div class="filters-row">
                        <button class="filter">
                            Filter
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                <path d="M15 5L5 15M5 5L15 15" stroke="#F3F3E7" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                        </button>
                        <button class="filter">
                            Filter
            ...
            <section class="all-recipes-section">
                <div class="recipe-card">
                    <div class="image-and-recipe-title">
                        <img src="images/Recipe_General_Tsos_Chicken_with_Bok_Choy_Jasmine_Rice/0101_2PRE07_General-Tsos-Chicken_97217_WEB_SQ_hi_res.jpg" alt="Bucatini in Tomato Sauce with Roasted Broccoli" width="370" height="370">
                        <div class="recipe-card-title">
                            <p class="recipe-name"><a href="recipe.html">General Tso's Chicken</a></p>
                            <p class="recipe-second-line">with Bok Choy & Jasmine Rice</p>
                        </div>
                    </div>
                    <div class="tags-line">
                ...
                <div class="recipe-card">
                    <div class="image-and-recipe-title">
                        <img src="images/Recipe_General_Tsos_Chicken_with_Bok_Choy_Jasmine_Rice/0101_2PRE07_General-Tsos-Chicken_97217_WEB_SQ_hi_res.jpg" alt="Bucatini in Tomato Sauce with Roasted Broccoli" width="370" height="370">
                        <div class="recipe-card-title">
                            <p class="recipe-name">General Tso's Chicken</p>
                            <p class="recipe-second-line">with Bok Choy & Jasmine Rice</p>
                        </div>
                    </div>
                    <div class="tags-line">
