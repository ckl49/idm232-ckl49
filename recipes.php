            ...
            <section class="header">
                ...
                <div class="tag-and-search-bar">
                    <div class="div-row">
                        ...
                        <a href="#" class="icon-btn" id="filter-btn">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                            <path d="M18.3332 2.5H1.6665L8.33317 10.3833V15.8333L11.6665 17.5V10.3833L18.3332 2.5Z" stroke="#000" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                        </a>
                    </div>
                    <?php if (!empty($filters)): ?>
                        <div class="tags-line">
                            <?php foreach ($filters as $filter): ?>
                                <?php
                                // Make a new array without the current filter
                ...
                <div id="filters-modal">
                    ...
                    <form id="filters-form" method="GET" action="recipes.php" class="list-of-filters">
                        ...
                        <div>
                            <p class="subheading">Protein</p>
                            <ul>
                                <li>
                                    <label class="filter-choice">
                                        <input type="checkbox" name="filter[]" value="chicken" <?php if (in_array("chicken", $filters)) echo "checked"; ?>
                                        >
                                        Chicken
                                      </label>
                                </li>
                                <li>
                                    <label class="filter-choice">
                                        <input type="checkbox" name="filter[]" value="pork" <?php if (in_array("pork", $filters)) echo "checked"; ?>
                                        >
                                        Pork
                                      </label>
                                </li>
                                <li>
                                    <label class="filter-choice">
                                        <input type="checkbox" name="filter[]" value="beef" <?php if (in_array( "beef", $filters)) echo "checked"; ?>
                                        >
                                        Beef
                                      </label>
                                </li>
                                <li>
                                    <label class="filter-choice">
                                        <input type="checkbox" name="filter[]" value="egg" <?php if (in_array("egg", $filters)) echo "checked"; ?>
                                        >
                                        Egg
                                    </label>
                                </li>
                                <li>
                                    <label class="filter-choice">
                                        <input type="checkbox" name="filter[]" value="seafood" <?php if (in_array("seafood", $filters)) echo "checked"; ?>
                                        >
                                        Seafood
                                    </label>
                                </li>
                                <li>
                                    <label class="filter-choice">
                                        <input type="checkbox"name="filter[]" value="vegetables" <?php if (in_array("vegetables", $filters)) echo "checked"; ?>
                                        >
                                        Vegetables
                                      </label>
                                </li>
                        ...
                        <div>
                            <p class="subheading">Cuisine</p>
                            <ul>
                                <li>
                                    <label class="filter-choice">
                                        <input type="checkbox" name="filter[]" value="chinese" <?php if (in_array("chinese", $filters)) echo "checked"; ?>
                                        >
                                        Chinese
                                      </label>
                                </li>
                                <li>
                                    <label class="filter-choice">
                                        <input type="checkbox" name="filter[]" value="middle eastern" <?php if (in_array("middle eastern", $filters)) echo "checked"; ?>
                                        >
                                        Middle Eastern
                                    </label>
                                </li>
                                <li>
                                    <label class="filter-choice">
                                        <input type="checkbox" name="filter[]" value="american" <?php if (in_array("american", $filters)) echo "checked"; ?>
                                        >
                                        American
                                      </label>
                                </li>
                                <li>
                                    <label class="filter-choice">
                                        <input type="checkbox" name="filter[]" value="mexican" <?php if (in_array("mexican", $filters)) echo "checked"; ?>
                                        >
                                        Mexican
                                    </label>
                                </li>
                                <li>
                                    <label class="filter-choice">
                                        <input type="checkbox" name="filter[]" value="korean" <?php if (in_array("korean", $filters)) echo "checked"; ?>
                                        >
                                        Korean
                                    </label>
                                </li>
                               <li>
                                    <label class="filter-choice">
                                        <input type="checkbox" name="filter[]" value="mediterranean" <?php if (in_array("mediterranean", $filters)) echo "checked"; ?>
                                        >
                                        Mediterranean
                                    </label>
                               </li>
                                <li>
                                    <label class="filter-choice">
                                        <input type="checkbox" name="filter[]" value="french" <?php if (in_array("french", $filters)) echo "checked"; ?>
                                        >
                                        French
                                    </label>
                                </li>
                                <li>
                                    <label class="filter-choice">
                                        <input type="checkbox" name="filter[]" value="thai" <?php if (in_array("thai", $filters)) echo "checked"; ?>
                                        >
                                        Thai
                                    </label>
                                </li>
                    ...
                    <div class="div-row">
                        <button class="button" id="close-btn">Close filters</button>
                        <button type="submit" form="filters-form" id="search-filters-btn">Search filters</button>
                    </div>
                </div>
            </section>
                            ...
                            <div class="recipe-card">
                                <div class="image-and-recipe-title">
                                    <picture>
                                        ...
                                        <img src="' . $first_image . '" alt="' . htmlspecialchars($row["name"]) . '">
                                    </picture>                                    
                                    <div class="recipe-card-title">
                                        <p class="recipe-name"> '. ($row["name"]) . '</p>
                                        <p class="recipe-second-line"> '. ($row["subheading"]) . '</p>
                                    </div>
                                </div>
                                <div class="tags-line">
                                    <div class="recipe-tag">
